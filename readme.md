...
## Install Duitku QRIS by Shopeepay plugins through Composer
...
1. Install the plugins: `composer require duitku_payment_gateway/duitku_shopeepay_qris`
2. Enable the plugin:  `bin/magento module:enable Duitku_Shopeepay`
...
6. Check the module status:  `bin/magento module:status Duitku_Shopeepay`
...
## Install Duitku QRIS by Shopeepay plugins from Download file
...
5. Run this command on terminal
    ...
    `bin/magento module:enable Duitku_Shopeepay`
    
    `bin/magento setup:upgrade`
    
    `bin/magento cache:clean`
    
    `bin/magento module:status Duitku_Shopeepay`


# Plugin Usage Instruction
## Basic Plugins Configuration

Before you begin, make sure that you have successfully installed and enabled Duitku QRIS by Shopeepay plugins.
Configure the Duitku QRIS by Shopeepay plugin in your Magento admin panel: 
...
4. In the Other Payment Method section, click Duitku QRIS by Shopeepay to extend Basic Settings and fill out the following fields:
